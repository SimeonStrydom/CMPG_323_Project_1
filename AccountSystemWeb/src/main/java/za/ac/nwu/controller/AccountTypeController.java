...
public class AccountTypeController {
    ...
    @GetMapping("/all")
    @ApiOperation(value = "Gets all the account types.", notes = "Returns a list of all account types")
    @ApiResponses(value = {
    ...
    @PostMapping("")
    @ApiOperation(value = "Creates a new AccountTypes.", notes = "Creates a new AccountType in DB")
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "Account types returned", response = GeneralResponse.class),
            @ApiResponse(code = 400, message = "Bad Request", response = GeneralResponse.class),
            @ApiResponse(code = 500, message = "Internal server error", response = GeneralResponse.class)})
    public ResponseEntity<GeneralResponse<AccountTypeDto>> create(@ApiParam(value = "Request body to create new AccountType", required = true)
